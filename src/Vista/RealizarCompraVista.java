 ...
 * @author RODRI
 */
public class RealizarCompraVista extends javax.swing.JInternalFrame {
    ...
    public RealizarCompraVista() {
        initComponents();
        // Obtiene el tamaño del JDesktopPane contenedor
        ...
        for (RelacionProductoProveedor p : x.listarrelacionActivas()) {
           if(cantidad==0){
            modelo.addRow(new Object[]{
              p.getProveedor().getIdProveedor(),p.getProducto().getIdProducto(),  p.getProducto().getNombreProducto(),p.getProveedor().getRazonSocial(),p.getProducto().getPrecioActual(), cantidad, "Seleccione una cantidad" });}
